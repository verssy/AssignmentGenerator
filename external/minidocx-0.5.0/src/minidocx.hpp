...
public:
    ...
    void SetTopBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                       const char *color = "auto");
    void SetBottomBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                          const char *color = "auto");
    void SetLeftBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                        const char *color = "auto");
    void SetRightBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                         const char *color = "auto");
    void SetInsideHBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                           const char *color = "auto");
    void SetInsideVBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                           const char *color = "auto");
    void SetInsideBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                          const char *color = "auto");
    void SetOutsideBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                           const char *color = "auto");
    void SetAllBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                       const char *color = "auto");
    void SetBorders_(const char *elemName, const BorderStyle style, const double width,
                     const char *color);
...
public:
     ...
     */
    void SetPageNumber(const PageNumberFormat fmt = PageNumberFormat::Decimal,
...
public:
    ...
    Run AppendRun(const std::string &text, const double fontSize, const std::string &fontAscii,
    ...
    void SetTopBorder(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                      const char *color = "auto");
    void SetBottomBorder(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                         const char *color = "auto");
    void SetLeftBorder(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                       const char *color = "auto");
    void SetRightBorder(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                        const char *color = "auto");
    void SetBorders(const BorderStyle style = BorderStyle::Single, const double width = 0.5,
                    const char *color = "auto");
    void SetBorders_(const char *elemName, const BorderStyle style, const double width,
                     const char *color);
